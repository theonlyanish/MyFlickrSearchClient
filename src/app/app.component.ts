...
export class AppComponent {
  ...
  pagination() {
    this.isLoading = true;
    this._flickrService.getImages(this.pageNumber, this.inputQuery.value).subscribe((result: { photos: { photo: any; }; }) => {
  ...
  searchQuery() {
    if (this.inputQuery.value == "") {
      ...
      this.isLoading = true;
      this._flickrService.getImages(this.pageNumber, this.inputQuery.value).subscribe((result: { photos: { photo: any; total: null; }; }) => {
        this.inputList = result.photos.photo;
  ...
  imageInfo(id : number) {
    this._flickrService.getImageInfo(id).subscribe((result: { photo: null; }) => {
